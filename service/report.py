...
# 这两个数都是 demo 期的经验值，接了历史样本要重新标。
METRICS = [
    ("flame_fill_ratio_pct",      "火焰充满度",         "%", 100, (25, 60),   "偏低", "偏高", False),
    ("centroid_offset_total_pct", "火焰中心偏斜",       "%", 100, (0, 15),    "",     "偏大", False),
    ("centroid_offset_x_pct",     "水平偏移（负=偏左）", "%", 100, (0, 10),    "偏左", "偏右", True),
    ("centroid_offset_y_pct",     "垂直偏移（负=偏上）", "%", 100, (0, 10),    "偏上", "偏下", True),
    ("temp_index_mean",           "相对亮温均值",       "",  1,   (0.35, 0.7), "偏低", "偏高", False),
    ("temp_index_p95",            "相对亮温 P95",       "",  1,   (0.5, 0.85), "偏低", "偏高", False),
    ("high_temp_area_pct",        "高温区占比",         "%", 100, (5, 25),    "偏小", "偏大", False),
    ("contour_circularity",       "轮廓圆度（1=正圆）",  "",  1,   (0.6, 1),   "破碎", "",     False),
    ("hot_pixels_near_edge_pct",  "边缘带高温像素",     "%", 100, (0, 5),     "",     "偏高", False),
